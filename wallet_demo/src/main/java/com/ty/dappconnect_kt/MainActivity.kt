...
class MainActivity : AppCompatActivity() {
    ...
    private fun handleConnectUri(uri: Uri?) {
        ...
        if (request.method != null && request.method.equals("provider_authorization")) {
            DAppConnect.walletBuildAndSaveSession(request)
            ...
            DAppConnect.setOnSignRequestMessageCallback(object : OnSignRequestMessageCallback {
                        ...
                        if (TEST_MODEL) {
                            Handler().postDelayed({
                                if (RandomUtils.randomBoolean()) {
                                    ...
                                    DAppConnect.sendSignResponse(id, true, signature, false, null)
